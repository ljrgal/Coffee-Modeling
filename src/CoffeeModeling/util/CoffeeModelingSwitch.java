...
public class CoffeeModelingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CoffeeModelingPackage.ORIGIN: {
				Origin origin = (Origin)theEObject;
				T result = caseOrigin(origin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoffeeModelingPackage.PRODUCT_UNITY: {
				ProductUnity productUnity = (ProductUnity)theEObject;
				T result = caseProductUnity(productUnity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoffeeModelingPackage.DEFECT: {
				Defect defect = (Defect)theEObject;
				T result = caseDefect(defect);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoffeeModelingPackage.PEOPLE: {
				People people = (People)theEObject;
				T result = casePeople(people);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoffeeModelingPackage.PROCESS: {
				CoffeeModeling.Process process = (CoffeeModeling.Process)theEObject;
				T result = caseProcess(process);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoffeeModelingPackage.FEATURE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Product Unity</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Product Unity</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProductUnity(ProductUnity object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseProcess(CoffeeModeling.Process object) {
		return null;
	}
